...
Sử dụng Groq API (MIỄN PHÍ) để phân tích bài báo
"""
...
class GroqAnalyzer:
    """Class phân tích bài báo với Groq (100% MIỄN PHÍ)"""
    ...
    def __init__(self):
        ...
        # Model miễn phí tốt nhất
        self.model = "llama-3.3-70b-versatile" # Miễn phí, cực nhanh!
        # Hoặc: "mixtral-8x7b-32768" - cũng miễn phí
    ...
    def analyze(self, text: str, filename: str) -> dict:
        ...
        try:
            ...
            # Gọi API Groq (MIỄN PHÍ!)
            response = self.client.chat.completions.create(
                model=self.model,
                messages=[
                    {
                        "role": "system",
                        "content": "Bạn là chuyên gia phân tích bài báo khoa học với 10 năm kinh nghiệm. Bạn chỉ trả về JSON thuần túy, không thêm text nào khác."
                    },
                    {
                        "role": "user",
                        "content": prompt
    ...
    def _create_prompt(self, text: str) -> str:
        ...
        Returns:
            str: Prompt
        """
        prompt = f"""Phân tích bài báo khoa học sau đây và trả về kết quả dưới dạng JSON với format chính xác như sau:
