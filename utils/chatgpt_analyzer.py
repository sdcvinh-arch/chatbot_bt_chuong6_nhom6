"""
ChatGPT Analyzer Module
Sử dụng OpenAI ChatGPT API để phân tích bài báo
"""
...
class ChatGPTAnalyzer:
    """Class phân tích bài báo với ChatGPT (OpenAI)"""
    ...
    def __init__(self):
        ...
        # Hoặc dùng: "gpt-4o" (đắt hơn nhưng tốt nhất)
        # Hoặc dùng: "gpt-3.5-turbo" (rẻ nhất)
...
"""
    ...
    def _parse_response(self, response_text: str) -> dict:
        """
        Parse JSON response từ ChatGPT
